...
layouts =
{
    awful.layout.suit.tile,             -- Большое слева, остальные справа.
    awful.layout.suit.tile.left,        -- Большое справа, остальные слева.
    awful.layout.suit.tile.bottom,      -- Большое сверху, остальные снизу.
    awful.layout.suit.tile.top,         -- Большое снизу, остальные сверху.
    awful.layout.suit.fair,             -- Справедливое распределение.  
    awful.layout.suit.fair.horizontal,  -- По горизонтали одинакового размера.
    awful.layout.suit.max,              -- На весь экран.
--    awful.layout.suit.floating,         -- Плавающие (?)
--    awful.layout.suit.spiral,           -- Спиральное (?)
--    awful.layout.suit.spiral.dwindle,   -- Вокруг окон появляется небольшой отступ.
--    awful.layout.suit.max.fullscreen,   -- На весь экран, без верхней полоски
--    awful.layout.suit.magnifier         -- Цикличное переключение. Одно в центре.
}
-- }}}
...
tags = {
   ...
   layouts = {layouts[1], layouts[7], layouts[7], layouts[5], layouts[5], layouts[7]}
}
...
-- %I - 12-hours
mytextclock = awful.widget.textclock({ align = "right" }, "%d %B, %A | %H:%M:%S ", 1)
